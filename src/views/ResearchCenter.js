...
export default function ResearchCenter() {
  ...
  return (
    <>
      <section
        className='pt-16 items-top flex lg:h-screen'
      ...
      >
        <div className='max-w-xl px-6 pt-24 mx-auto lg:px-8 lg:max-w-7xl'>
          ...
          <p className='pt-6 text-sm lg:text-lg xl:text-xl leading-relaxed text-graydark font-montregular text-left'>
		...
		c3.529,0,6.881-1.169,9.692-3.424c4.338-3.48,6.928-9.156,6.928-15.184C73.436,29.191,64.48,20.24,53.473,20.24z'
          ...
          {/* <p className='pl-4 text-sm lg:text-lg xl:text-xl leading-relaxed text-graydark font-montregular text-left'>
          NGRC&#39;s primary research focus is on Life Science, Education,
          Energy and Environment. We want to make sure that other disciplines
          than the conventional are allowed space in the research arena. By
          inviting different schools of thought and traditions to complement
          ...
          In particular, what differentiates us from other science centers, is
          our dedication to normalizing the research behind, for example,
          neuroscience, quantum physics and epigenetics, targeted to better the
          mental and physical wellbeing of people and empower them to change
          their lives.
        </p> */}
        </div>
      </section>
      <section id='life-science' className='h-screen bg-red-700'>
        Life science
      </section>
    </>
  );
