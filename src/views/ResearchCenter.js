      ...
      >
        <div className='container max-w-xl p-6 py-14 lg:py-24 mx-auto space-y-24 lg:px-8 lg:max-w-7xl'>
          {/* <div>
            ...
            <p className='max-w-3xl mx-auto mt-4 text-xl text-center dark:text-coolGray-400'>
              That helps bring science into everyday life
            </p>
          </div> */}
          <div className='grid lg:gap-4 lg:grid-cols-2 lg:items-center'>
            <div>
              ...
              <p className='mt-4 dark:text-coolGray-400 text-graylight text-base md:text-md lg:text-lg font-montregular'>
                ...
                “truth” that we are the sum of our genes, was questioned. That
                our inherited DNA is the only determinator of who we are,
                biologically. But around 1990 the epigenetic science gained
                speed, and scientists started to get interested in the cellular
                mechanisms that can regulate our genes in different ways. Our
                ambition is to highlight the holistic connection between mind
                and body, and how they impact one another. How can epigenetics
                and quantum physics help us understand that if we change the way
                we think and feel, we can influence our internal and external
                environment?
              </p>
              <p className='mt-4 dark:text-coolGray-400 text-graylight text-base md:text-md lg:text-lg font-montregular'>
                Researchers such Joe Dispenza, Gregg Braden and Bruce Lipton all
                have in common that they’ve started to pave the ground for the
                use of evidence-based healing and joy promoting techniques. And
                our ambition is to take it even further.
              </p>
            </div>
                    ...
                    <div className='flex items-center justify-center w-10 h-10 rounded-md dark:bg-violet-400 dark:text-coolGray-900'>
                      ...
                      >
                        <g id='Layer_7' data-name='Layer 7'>
                          <path d='M32,10.5A21.53,21.53,0,0,0,10.5,32c1.18,28.52,41.82,28.51,43,0A21.53,21.53,0,0,0,32,10.5ZM43.42,26.86,31,39.26a1.51,1.51,0,0,1-2.12,0l-8.32-8.32a1.5,1.5,0,0,1,2.12-2.12L30,36.08,41.3,24.74A1.5,1.5,0,0,1,43.42,26.86Z' />
                        </g>
                      </svg>
                    </div>
                  </div>
