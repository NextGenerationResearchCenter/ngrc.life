export default function Hero() {
  return (
    <section className='header relative pt-12 items-center flex h-screen max-h-860-px h-100'>
        ...
        <div className='w-full md:w-8/12 lg:w-8/12 xl:w-7/12 px-4'>
          <div className='pt-32 sm:pt-0'>
            <img
              ...
              className='mb-12'
            />
            <span className='font-bold text-5xl text-gray-900 mb-0'>
              Next Generation Research Center
            </span>
            <br />
            <h3 className='mt-1 font-semibold text-3xl text-gray-700'>
            ...
            <div className='mt-14'>
              <a
                ...
                target='_blank'
                rel='noreferrer'
                className='text-white text-lg font-bold px-6 py-4 rounded-full outline-none focus:outline-none mr-4 mb-1 bg-gray-400 active:bg-purple-500 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150'
              >
                Read more about us
              </a>
              <a
                href='/'
                className='ml-1 text-white text-lg font-bold px-12 py-4 rounded-full outline-none focus:outline-none mr-1 mb-1 bg-gray-700 active:bg-purple-600 uppercase text-md shadow hover:shadow-lg ease-linear transition-all duration-150'
                target='_blank'
                rel='noreferrer'
              >
